...
class rf4x2MTS(Overlay):
    ...
    def internal_capture(self, buf, num_chan=4):
        """
        internal_capture() is, most simply, a way of acquiring data samples
        which are written to the ADC memory.
            buf: np.array - buffer of shape (num_chan, num_samples) to be filled with ADC stream data.
            num_chan: int - leave as default. Captures data on all 4 streams of RFSoC 4x2 Dev board.
        """
